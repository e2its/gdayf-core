...
class LoadConfig(object):
    ...
    ## Constructor
    def __init__(self, configfile=r'D:\e2its-dayf.svn\gdayf\branches\0.1.2-mrazul\src\gdayf\conf\config.json'):
...
class LoadLabels(object):
    ...
    ## Constructor
    def __init__(self, lang='en', configfile=r'D:\e2its-dayf.svn\gdayf\branches\0.1.2-mrazul\src\gdayf\conf\labels.json'):
        # @var _config protected member variable to store config parameters
        self._config = None
        # @var _configfile protected member variable to store configfile path
        self._configfile = configfile
