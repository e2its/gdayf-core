if __name__ == "__main__":
    ...
    json_file = open(r'D:\e2its-dayf.svn\gdayf\branches\0.0.2-jlsanchez\test\json\algorithm_result(ar)-regression.json')
    ...
    for file in os.listdir(r'D:\Data\models\h2o\PoC-regression\train\json'):
        analysis_models = H2OHandler()
        json_file = open(r'D:\Data\models\h2o\PoC-regression\train\json' + '/' + file)
