...
docker-compose -f /home/e2its/docker/scripts/yaml/gdayf-platform.yml up -d ubuntu-h2o-2 spark-worker-2 
docker-compose -f /home/e2its/docker/scripts/yaml/gdayf-platform.yml up -d ubuntu-h2o-3 spark-worker-3 
